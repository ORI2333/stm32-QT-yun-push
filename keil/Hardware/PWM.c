...
void Servo_PWM_Init(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Prescaler = 72 - 1;   // 1MHz计数
...
{
	TIM_SetCompare1(TIM2, Compare*200);		//设置CCR2的值
}
/**
  * 函    数：PWM设置CCR
  * 参    数：Compare 要写入的CCR的值，范围：0~100
...
{
	TIM_SetCompare3(TIM2, Compare*200);		//设置CCR2的值
}
//设置舵机角度
